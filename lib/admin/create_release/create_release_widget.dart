...
import 'create_release_model.dart';
export 'create_release_model.dart';

class CreateReleaseWidget extends StatefulWidget {
  const CreateReleaseWidget({Key? key}) : super(key: key);

  @override
  _CreateReleaseWidgetState createState() => _CreateReleaseWidgetState();
}

class _CreateReleaseWidgetState extends State<CreateReleaseWidget>
    with TickerProviderStateMixin {
  late CreateReleaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateReleaseModel());

    _model.textController1 ??= TextEditingController();
    _model.artisteNameController ??= TextEditingController();
    _model.locationNameController ??= TextEditingController();
    _model.appleMusicController ??= TextEditingController();
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Enter Song/Album Name',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        controller: _model.artisteNameController,
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: 'Enter Artiste Name',
                          labelStyle: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
                        ...
                        validator: _model.artisteNameControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.appleMusicController,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Enter Apple Music Link',
                            labelStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
                          ...
                          textAlign: TextAlign.start,
                          validator: _model.appleMusicControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Enter Spotify Music Link',
                            labelStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
