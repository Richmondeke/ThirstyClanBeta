...
import 'edit_artiste_model.dart';
export 'edit_artiste_model.dart';

class EditArtisteWidget extends StatefulWidget {
  const EditArtisteWidget({
    Key? key,
    this.artiste,
  }) : super(key: key);

  final DocumentReference? artiste;

  @override
  _EditArtisteWidgetState createState() => _EditArtisteWidgetState();
}

class _EditArtisteWidgetState extends State<EditArtisteWidget>
    with TickerProviderStateMixin {
  late EditArtisteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditArtisteModel());
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        controller: _model.descriptiomController,
                        obscureText: false,
                        decoration: InputDecoration(
                        ...
                        validator: _model.descriptiomControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          controller: _model.twitterController,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Enter Profile URL',
                            labelStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
                          ...
                          textAlign: TextAlign.start,
                          validator: _model.twitterControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
