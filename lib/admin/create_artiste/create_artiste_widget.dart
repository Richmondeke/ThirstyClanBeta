...
import 'create_artiste_model.dart';
export 'create_artiste_model.dart';

class CreateArtisteWidget extends StatefulWidget {
  const CreateArtisteWidget({Key? key}) : super(key: key);

  @override
  _CreateArtisteWidgetState createState() => _CreateArtisteWidgetState();
}

class _CreateArtisteWidgetState extends State<CreateArtisteWidget>
    with TickerProviderStateMixin {
  late CreateArtisteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateArtisteModel());
