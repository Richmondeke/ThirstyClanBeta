...
import 'checkoutpage_copy_model.dart';
export 'checkoutpage_copy_model.dart';
...
class CheckoutpageCopyWidget extends StatefulWidget {
  ...
  @override
  _CheckoutpageCopyWidgetState createState() => _CheckoutpageCopyWidgetState();
}
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return CartitemWidget(
                                key: Key(
                                    'Keyq1h_${listViewIndex}_of_${listViewCartRecordList.length}'),
                              );
                            },
                          );
                        },
                      ...
                      children: [
                        ...
                        StreamBuilder<List<CartRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final textCartRecord = textCartRecordList.isNotEmpty
                                ? textCartRecordList.first
                                : null;
                            return Text(
                              widget.amount!.toString(),
