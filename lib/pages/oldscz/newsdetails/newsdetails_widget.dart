...
import 'newsdetails_model.dart';
export 'newsdetails_model.dart';
...
class NewsdetailsWidget extends StatefulWidget {
  ...
  final DocumentReference? newsdetails;
...
class _NewsdetailsWidgetState extends State<NewsdetailsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<NewsRecord>(
      stream: NewsRecord.getDocument(widget.newsdetails!),
      builder: (context, snapshot) {
        ...
        final newsdetailsNewsRecord = snapshot.data!;
                        ...
                        child: Column(
                          ...
                          children: [
                            Stack(
                              children: [
                                Image.network(
                                  newsdetailsNewsRecord.newsimage,
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: Text(
                                        newsdetailsNewsRecord.headline,
                                        style: FlutterFlowTheme.of(context)
                                            .headlineMedium
                                            .override(
                                              fontFamily: 'DM Sans',
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 4.0),
                                      child: Text(
                                        newsdetailsNewsRecord.description,
