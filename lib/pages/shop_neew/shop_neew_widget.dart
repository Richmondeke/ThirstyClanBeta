...
import 'shop_neew_model.dart';
export 'shop_neew_model.dart';

class ShopNeewWidget extends StatefulWidget {
  const ShopNeewWidget({Key? key}) : super(key: key);

  @override
  _ShopNeewWidgetState createState() => _ShopNeewWidgetState();
}

class _ShopNeewWidgetState extends State<ShopNeewWidget> {
  late ShopNeewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopNeewModel());
