...
import 'shop2_copy_model.dart';
export 'shop2_copy_model.dart';

class Shop2CopyWidget extends StatefulWidget {
  const Shop2CopyWidget({Key? key}) : super(key: key);

  @override
  _Shop2CopyWidgetState createState() => _Shop2CopyWidgetState();
}

class _Shop2CopyWidgetState extends State<Shop2CopyWidget> {
  late Shop2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Shop2CopyModel());
  }
