...
class ProductdetailsWidget extends StatefulWidget {
  ...
  final ProductsRecord? products1;
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Hero(
                      tag: widget.products1!.productImage,
                      transitionOnUserGestures: true,
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(0.0),
                        child: Image.network(
                          widget.products1!.productImage,
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 0.0),
                            child: Text(
                              'These are limited pieces, cop one before it runs out.',
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    fontFamily: 'DM Sans',
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FFButtonWidget(
                          onPressed: () async {
                            FFAppState().update(() {
                              FFAppState().sum =
                                  buttonProductsRecord!.productPrice;
                              FFAppState().Cartitems =
                                  FFAppState().Cartitems.toList();
                              FFAppState().NewCart = getJsonField(
                                FFAppState().NewCart,
                                r'''$''',
                              );
                            });
                            ...
                            final cartCreateData = createCartRecordData(
                              product: widget.products1!.reference.id,
                              amount: widget.products1!.productPrice,
                              quantity: _model.countControllerValue,
                              productref: widget.products1!.reference,
                            );
