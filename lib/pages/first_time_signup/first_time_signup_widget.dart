...
import 'first_time_signup_model.dart';
export 'first_time_signup_model.dart';

class FirstTimeSignupWidget extends StatefulWidget {
  const FirstTimeSignupWidget({Key? key}) : super(key: key);

  @override
  _FirstTimeSignupWidgetState createState() => _FirstTimeSignupWidgetState();
}

class _FirstTimeSignupWidgetState extends State<FirstTimeSignupWidget> {
